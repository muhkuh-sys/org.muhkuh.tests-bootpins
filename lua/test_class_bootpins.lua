...
function TestClassBootpins:_init(strTestName, uiTestCase, tLogWriter, strLogLevel)
  ...
  self:__parameter {
    ...
    P:SC('expected_chip_id', 'The expected chip ID.'):
      required(true):
      constraint('NETX500,NETX100,NETX50,NETX10,NETX51A_NETX50_COMPATIBILITY_MODE,NETX51B_NETX50_COMPATIBILITY_MODE,NETX51A,NETX51B,NETX52A,NETX52B,NETX4000_RELAXED,NETX4000_FULL,NETX4000_SMALL,NETX90_MPW,NETX90,NETX90B,NETX90BPHYR3'),
